...
/* PHRASES removed in favor of Date Bar */
...
@keyframes badgeFloat { 0%,100%{transform: translateY(0) scale(1);} 50%{transform: translateY(-6px) scale(1.02);} }
@keyframes badgeGlow { 0%,100%{box-shadow: 0 0 20px rgba(34,197,94,0.3), 0 8px 24px rgba(16,185,129,0.2), inset 0 1px 2px rgba(255,255,255,0.2);} 50%{box-shadow: 0 0 30px rgba(34,197,94,0.5), 0 12px 36px rgba(16,185,129,0.35), inset 0 1px 2px rgba(255,255,255,0.3);} }
...
/* ── ULTRA-MODERN DATE BAR ── */
@keyframes fluidGradient {
  0% { background-position: 0% 50%; box-shadow: 0 30px 60px -12px rgba(0, 0, 0, 0.6), 0 0 20px rgba(77, 166, 255, 0.2); border-color: rgba(77, 166, 255, 0.3); }
  50% { background-position: 100% 50%; box-shadow: 0 30px 60px -12px rgba(0, 0, 0, 0.6), 0 0 40px rgba(0, 229, 160, 0.4); border-color: rgba(0, 229, 160, 0.5); }
  100% { background-position: 0% 50%; box-shadow: 0 30px 60px -12px rgba(0, 0, 0, 0.6), 0 0 20px rgba(191, 127, 255, 0.2); border-color: rgba(191, 127, 255, 0.3); }
}
...
[data-theme='light'] .modern-date-bar {
  background: linear-gradient(
    ...
    rgba(77, 166, 255, 0.2) 33%, 
    rgba(0, 229, 160, 0.2) 66%, 
...
[data-theme='light'] .date-segment:hover {
...
.date-input-modern::-webkit-clear-button {
  display: none;
  -webkit-appearance: none;
}
.city-input-modern {
...
@media (max-width: 768px) {
  ...
  /* City dropdown mobile — same width as the city segment */
  .city-dropdown {
    left: 0;
    right: 0;
    width: 100%;
...
function WhatsAppWidget({ onToggleTheme, isBlueTheme, selectedLang, isMobile }) {
...
5. "seats" : le nombre de places (ex: "5 places" -> "5", "7 places" -> "7", "5 places" -> "5"). S'il n'y a pas de nombre de places spécifié, laisse vide "".
    ...
    // Date Bar logic or other effects could go here
  ...
  return () => {cancelAnimationFrame(id); window.removeEventListener("resize", resize); };
    ...
    return (
            ...
            <div style={{ position: "relative", zIndex: 1, overflowX: "hidden", width: "100%" }}>
                            ...
                            {isMobile ? (
                                <div style={{ display: "flex", alignItems: "center", gap: 8, position: "relative" }}>
                                    ...
                                    <div className="mobile-menu-wrap" style={{ position: "relative" }}>
                                        ...
                                        {mobileMenuOpen && (
                                            <div dir={selectedLang === "AR" ? "rtl" : "ltr"} style={{
                                                position: "absolute", top: "calc(100% + 15px)", right: "-18.6px", left: "auto",
                                                width: 382, borderRadius: 24, padding: "20px",
                                                background: isDarkMode ? "linear-gradient(160deg, rgba(10,8,24,0.98) 0%, rgba(15,12,36,0.99) 100%)" : "linear-gradient(160deg, rgba(255,255,255,0.98) 0%, rgba(240,253,244,0.99) 100%)",
                                                border: `1px solid ${isDarkMode ? "rgba(168,85,247,0.18)" : "rgba(16,185,129,0.18)"}`,
                                                boxShadow: isDarkMode ? "0 24px 60px rgba(0,0,0,0.7), 0 0 0 1px rgba(168,85,247,0.1), inset 0 1px 0 rgba(255,255,255,0.06)" : "0 24px 60px rgba(0,0,0,0.12), 0 0 0 1px rgba(16,185,129,0.12), inset 0 1px 0 rgba(255,255,255,0.8)",
                                                backdropFilter: "blur(20px)", zIndex: 999,
                                                animation: "fadeUp 0.3s cubic-bezier(0.16,1,0.3,1)"
                                            }}>
                                                <div style={{ fontFamily: "'Syne',sans-serif", fontSize: 11, fontWeight: 800, color: "var(--text-muted)", textTransform: "uppercase", letterSpacing: "0.1em", marginBottom: 12 }}>{selectedLang === "AR" ? "اللغة" : "Langue"}</div>
                                                <div style={{ display: "flex", gap: 8, marginBottom: 20 }}>
                                                    {[
                                                        ...
                                                        <button
                                                            key={lang.code}
                                                            onClick={() => { setSelectedLang(lang.code); setMobileMenuOpen(false); }}
                                                            style={{
                                                                ...
                                                                border: `1px solid ${selectedLang === lang.code ? "transparent" : "var(--card-border)"}`,
                                ...
                                <>
                                    ...
                                    <div className="login-menu-wrap" style={{ position: "relative" }}>
                                        ...
                                        <div style={{
                                            ...
                                            zIndex: 999,
                                            left: selectedLang === "FR" ? "90px" : (selectedLang === "AR" ? "42%" : "34%"), // eslint-disable-line no-dupe-keys
                ...
                <section style={{
                    ...
                    <div style={{ position: "relative", zIndex: 10, width: "100%", display: "flex", flexDirection: "column", alignItems: "center" }}>
                        ...
                        <div className="modern-date-bar" style={{ top: isMobile ? "0px" : (selectedLang === "AR" ? "0px" : "33px") }}>
                            <div className="date-segment" style={{ overflow: 'visible' }}>
                                ...
                                {/* Helper input to anchor the popup perfectly at the bottom */}
                                <input
                                    type="date"
                                    ref={startDateRef}
                                    style={{ position: 'absolute', bottom: -10, left: 0, width: '100%', height: '1px', opacity: 0, pointerEvents: 'none', border: 'none', padding: 0 }}
                                    value={startDate}
                                    onChange={e => setStartDate(e.target.value)}
                                    tabIndex={-1}
                                />
                            ...
                            <div
                                ...
                                style={{ flex: 1.2, overflow: "visible" }}
                        ...
                        <div style={{
                            ...
                            <span style={{
                                ...
                                textAlign: "center",
                                position: "relative",
                                top: isMobile ? 0 : (selectedLang === "AR" ? -10 : 15),
                        ...
                        <div style={{
                            display: "flex", gap: isMobile ? 16 : (selectedLang === "AR" ? 26 : 22),
                            ...
                            bottom: isMobile ? "auto" : (selectedLang === "AR" ? "-20px" : "-52px")
                        }}>
                            <button
                                onClick={() => window.location.href = "/loginagence"}
                                className="primary-btnDE"
                                style={{ padding: isMobile ? "14px 24px" : (selectedLang === "AR" ? "18px 60px" : "17px 56px"), fontSize: selectedLang === "AR" ? (isMobile ? 15 : 20) : (isMobile ? 14.5 : 18), width: isMobile ? "100%" : "auto", maxWidth: isMobile ? "360px" : "none", fontFamily: "'DM Sans','Syne',sans-serif" }}
                            >
                                {t("hero.startFree", "Start For Free")} <ArrowRightIcon size={selectedLang === "AR" ? 19 : 19} />
                            </button>
                            <button onClick={() => window.scrollBy({ top: 500, behavior: "smooth" })} className="secondary-btn" style={{ background: "rgba(255,255,255,0.05)", border: "1px solid rgba(255,255,255,0.2)", color: "#fff", padding: isMobile ? "13px 24px" : (selectedLang === "AR" ? "18px 40px" : "16px 36px"), fontSize: selectedLang === "AR" ? (isMobile ? 15 : 20) : (isMobile ? 14.5 : 18), width: isMobile ? "100%" : "auto", maxWidth: isMobile ? "360px" : "none", fontFamily: "'DM Sans','Syne',sans-serif" }}>
                            ...
                            <div dir="ltr" style={{
                                ...
                                {searchResults.map((car, idx) => (
                                    <div key={car.id} dir={selectedLang === "AR" ? "rtl" : "ltr"} className="fleet-card" style={{
                                        ...
                                        <div style={{ position: "relative", height: isMobile ? 299 : 220, overflow: "hidden" }}>
                                            <img
                ...
                <section style={{ padding: isMobile ? "32px 0" : "50px 0", position: "relative", top: isMobile ? 40 : 60, paddingTop: isMobile ? "120px" : "57px" }}>
                    ...
                    <div dir="ltr" style={{ display: "flex", flexDirection: "column", gap: isMobile ? 24 : 40, position: "relative", zIndex: 1 }}>
                        ...
                        <div style={{ display: "flex", width: "fit-content" }}>
                            <div style={{ display: "flex", gap: isMobile ? 40 : 100, alignItems: "center", paddingRight: isMobile ? 40 : 100, animation: "marquee 40s linear infinite" }}>
                                {["Mercedes-Benz", "Porsche", "BMW", "Audi", "Range Rover", "Maserati", "Aston Martin", "Tesla",
                                    "Mercedes-Benz", "Porsche", "BMW", "Audi", "Range Rover", "Maserati", "Aston Martin", "Tesla"].map((brand, i) => {
                                        ...
                                        return (
                                            <div key={`r1-${i}`} style={{ display: "flex", alignItems: "center", gap: isMobile ? 8 : 16, opacity: 1, transition: "all 0.5s cubic-bezier(0.175,0.885,0.32,1.275)", cursor: "pointer", filter: "grayscale(0%)" }}
                                                onMouseEnter={e => { e.currentTarget.style.transform = "scale(1.15) translateY(-5px)"; }}
                                                onMouseLeave={e => { e.currentTarget.style.transform = "scale(1) translateY(0)"; }}>
                                                <div style={{ width: isMobile ? 24 : 44, height: isMobile ? 24 : 44, borderRadius: "50%", background: `${color}18`, border: `1px solid ${color}50`, display: "flex", alignItems: "center", justifyContent: "center", boxShadow: `0 8px 20px ${color}25`, transition: "all 0.5s" }}>
                                                    <GlobeIcon size={isMobile ? 12 : 20} color={color} />
                                                </div>
                                                <span style={{ fontFamily: "'Syne',sans-serif", fontWeight: 800, fontSize: isMobile ? 14 : 36, letterSpacing: "-0.02em", color: color, whiteSpace: "nowrap", transition: "color 0.5s", textShadow: `0 0 40px ${color}30` }}>{brand}</span>
                                            </div>
                                        );
                                    })}
                            </div>
                        ...
                        {/* ROW 2 */}
                        <div style={{ display: "flex", width: "fit-content" }}>
                            <div style={{ display: "flex", gap: isMobile ? 40 : 100, alignItems: "center", paddingRight: isMobile ? 40 : 100, animation: "marquee 50s linear infinite reverse" }}>
                                {["Jaguar", "Lexus", "Volvo", "Alfa Romeo", "Bentley", "Ferrari", "Lamborghini", "Bugatti",
                                    "Jaguar", "Lexus", "Volvo", "Alfa Romeo", "Bentley", "Ferrari", "Lamborghini", "Bugatti"].map((brand, i) => {
                                        const color = getColor(brand);
                                        return (
                                            <div key={`r2-${i}`} style={{ display: "flex", alignItems: "center", gap: isMobile ? 6 : 16, opacity: 1, transition: "all 0.5s cubic-bezier(0.175,0.885,0.32,1.275)", cursor: "pointer", filter: "grayscale(0%)" }}
                                                onMouseEnter={e => { e.currentTarget.style.transform = "scale(1.15) translateY(-5px)"; }}
                                                onMouseLeave={e => { e.currentTarget.style.transform = "scale(1) translateY(0)"; }}>
                                                <div style={{ width: isMobile ? 20 : 36, height: isMobile ? 20 : 36, borderRadius: "50%", background: `${color}18`, border: `1px solid ${color}50`, display: "flex", alignItems: "center", justifyContent: "center", boxShadow: `0 6px 16px ${color}20` }}>
                                                    <ZapIcon size={isMobile ? 10 : 16} color={color} />
                                                </div>
                                                <span style={{ fontFamily: "'Syne',sans-serif", fontWeight: 800, fontSize: isMobile ? 12 : 24, letterSpacing: "-0.01em", color: color, whiteSpace: "nowrap", textShadow: `0 0 30px ${color}25` }}>{brand}</span>
                                            </div>
                                        );
                                    })}
                            </div>
      ...
      `}</style>
                ...
                <section style={{ padding: isMobile ? "10px 24px" : "10px 20px", position: "relative", fontFamily: "'DM Sans', sans-serif", overflow: "hidden" }}>
                    ...
                    <div style={{ maxWidth: 1240, margin: "0 auto", position: "relative" }}>
                        ...
                        <div style={{ textAlign: "center", marginBottom: 80, animation: mounted ? "fadeUp 0.7s ease both" : "none" }}>
                            ...
                            <h2 style={{ fontFamily: "'Syne', sans-serif", fontWeight: 900, fontSize: isMobile ? "clamp(36px,9vw,52px)" : "clamp(52px,7vw,84px)", color: "var(--text-main)", letterSpacing: isMobile ? -1 : -3, lineHeight: 1.1, marginBottom: 20 }}>
                        ...
                        <div style={{ display: "grid", gridTemplateColumns: isMobile ? "1fr" : "360px 1fr", gap: isMobile ? 32 : 80 }}>
                            ...
                            <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                                ...
                                <div style={{ display: "flex", gap: 10, marginTop: 20, paddingLeft: 4 }}>
                                    <button className="primary-btnE" onClick={() => navigate("/loginagence")}>{t("agencyOS.getStartedBtn", "Get Started")}</button>
                                    <button className="secondary-btn" onClick={() => window.scrollBy({ top: 400, behavior: "smooth" })}>{t("agencyOS.watchDemoBtn", "Watch Demo")}</button>
                                </div>
                            </div>
          ...
          `}</style>
            ...
            <WhatsAppWidget onToggleTheme={toggleTheme} isBlueTheme={isBlueTheme} selectedLang={selectedLang} isMobile={isMobile} />
        </div>
    );
}