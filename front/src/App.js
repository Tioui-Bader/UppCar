    ...
    /*   useEffect(() => {
      ...
      `;
          ...
          const enforceThemeAndTitle = () => {
              ...
              // --- POSITIONNEMENT DYNAMIQUE DU WIDGET ---
              // En arabe (RTL), le chatbot est à gauche. Sinon à droite.
              if (isArabicNow) {
                  chatWidget.style.setProperty('left', '20px', 'important');
                  chatWidget.style.setProperty('right', 'auto', 'important');
              ...
              // Aligner la fenêtre de chat elle-même par rapport au widget
              const chatWindow = shadowRoot.querySelector('.chat-window') || shadowRoot.querySelector('[class*="window"]');
              if (chatWindow) {
                  if (isArabicNow) {
                      chatWindow.style.setProperty('left', '0', 'important');
                      chatWindow.style.setProperty('right', 'auto', 'important');
                      chatWindow.style.setProperty('transform-origin', 'bottom left', 'important');
                  } else {
                      chatWindow.style.setProperty('right', '0', 'important');
                      chatWindow.style.setProperty('left', 'auto', 'important');
                      chatWindow.style.setProperty('transform-origin', 'bottom right', 'important');
                  }
              }
